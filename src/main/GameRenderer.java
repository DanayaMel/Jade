...
//        
        ...
        if (background != null) {
            ...
            for(int i=0; i<10;i++){
    		 g.drawImage(background, offsetX - screenWidth + i * 1220, i, null);}
//    		 g.drawImage(foreground, offsetX -  i * 1220, i, null);}
        }
